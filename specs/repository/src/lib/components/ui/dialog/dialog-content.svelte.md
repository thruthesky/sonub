...
description: dialog-content UI 컴포넌트
version: 1.0.0
type: svelte-component
category: ui-component
original_path: src/lib/components/ui/dialog/dialog-content.svelte
---
...
**파일 경로**: `src/lib/components/ui/dialog/dialog-content.svelte`
**파일 타입**: svelte-component
**카테고리**: ui-component

dialog-content UI 컴포넌트
