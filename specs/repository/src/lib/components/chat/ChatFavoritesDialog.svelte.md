---
name: ChatFavoritesDialog.svelte
description: ChatFavoritesDialog 컴포넌트
version: 1.0.0
type: svelte-component
category: component
original_path: src/lib/components/chat/ChatFavoritesDialog.svelte
---

# ChatFavoritesDialog.svelte

## 개요

**파일 경로**: `src/lib/components/chat/ChatFavoritesDialog.svelte`
**파일 타입**: svelte-component
**카테고리**: component

ChatFavoritesDialog 컴포넌트
