...
## Props/Parameters
State variables: displayName, photoUrl, gender, birthYear, birthMonth, birthDay, loading, saving, successMessage, errorMessage, photoPreview, fileInput, isPhotoUploading
