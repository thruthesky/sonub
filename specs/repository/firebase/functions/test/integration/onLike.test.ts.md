---
name: onLike.test.ts
description: onLike.test Cloud Function
version: 1.0.0
type: firebase-function
category: cloud-function
original_path: firebase/functions/test/integration/onLike.test.ts
---
...
**파일 경로**: `firebase/functions/test/integration/onLike.test.ts`
**파일 타입**: firebase-function
**카테고리**: cloud-function

onLike.test Cloud Function
