---
name: comment.handler.test.ts
description: comment.handler.test Cloud Function
version: 1.0.0
type: firebase-function
category: cloud-function
original_path: firebase/functions/test/unit/comment.handler.test.ts
---
...
**파일 경로**: `firebase/functions/test/unit/comment.handler.test.ts`
**파일 타입**: firebase-function
**카테고리**: cloud-function

comment.handler.test Cloud Function
