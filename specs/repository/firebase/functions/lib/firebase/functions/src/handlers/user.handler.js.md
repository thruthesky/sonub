---
name: user.handler.js
description: user.handler Cloud Function
version: 1.0.0
type: firebase-function
category: cloud-function
original_path: firebase/functions/lib/firebase/functions/src/handlers/user.handler.js
---
...
**파일 경로**: `firebase/functions/lib/firebase/functions/src/handlers/user.handler.js`
**파일 타입**: firebase-function
**카테고리**: cloud-function

user.handler Cloud Function
...
exports.handleUserDisplayNameUpdate = handleUserDisplayNameUpdate;
exports.handleUserPhotoUrlUpdate = handleUserPhotoUrlUpdate;
exports.handleUserBirthYearMonthDayUpdate = handleUserBirthYearMonthDayUpdate;
exports.handleUserGenderUpdate = handleUserGenderUpdate;
 ...
 */
async function handleUserCreate(uid, userData) {
    var _a;
 ...
 */
async function handleUserUpdate(uid, beforeData, afterData) {
    var _a, _b, _c, _d;
    logger.info("사용자 정보 업데이트 처리 시작", {
        uid,
        beforeDisplayName: (_a = beforeData === null || beforeData === void 0 ? void 0 : beforeData.displayName) !== null && _a !== void 0 ? _a : null,
        afterDisplayName: (_b = afterData === null || afterData === void 0 ? void 0 : afterData.displayName) !== null && _b !== void 0 ? _b : null,
    });
    const now = Date.now();
    const updates = {};
    // 1. createdAt 필드가 없으면 자동 생성
    if (afterData.createdAt === undefined || afterData.createdAt === null) {
        const createdAt = typeof (beforeData === null || beforeData === void 0 ? void 0 : beforeData.createdAt) === "number" ? beforeData.createdAt : now;
        updates[`users/${uid}/createdAt`] = createdAt;
        logger.info("createdAt 필드 자동 생성", { uid, createdAt });
    }
    // 2. displayName 또는 photoUrl이 변경되었는지 확인
    const displayNameChanged = (beforeData === null || beforeData === void 0 ? void 0 : beforeData.displayName) !== (afterData === null || afterData === void 0 ? void 0 : afterData.displayName);
    const photoUrlChanged = ((_c = beforeData === null || beforeData === void 0 ? void 0 : beforeData.photoUrl) !== null && _c !== void 0 ? _c : beforeData === null || beforeData === void 0 ? void 0 : beforeData.photoURL) !==
        ((_d = afterData === null || afterData === void 0 ? void 0 : afterData.photoUrl) !== null && _d !== void 0 ? _d : afterData === null || afterData === void 0 ? void 0 : afterData.photoURL);
    ...
    const needsDisplayNameLowerCase = afterData.displayName &&
    ...
    const birthYearMonthDayChanged = (beforeData === null || beforeData === void 0 ? void 0 : beforeData.birthYearMonthDay) !== (afterData === null || afterData === void 0 ? void 0 : afterData.birthYearMonthDay);
    if (afterData.birthYearMonthDay && birthYearMonthDayChanged) {
        // YYYY-MM-DD 형식 파싱
        const birthDateMatch = afterData.birthYearMonthDay.match(/^(\d{4})-(\d{2})-(\d{2})$/);
        if (birthDateMatch) {
 ...
 */
async function ensureCreatedAt(uid) {
 ...
 * @returns {Promise<{success: boolean; uid: string}>} 처리 결과
 */
async function handleUserDisplayNameUpdate(uid, beforeValue, afterValue) {
 ...
 * @returns {Promise<{success: boolean; uid: string}>} 처리 결과
 */
async function handleUserPhotoUrlUpdate(uid, beforeValue, afterValue) {
 ...
 * @returns {Promise<{success: boolean; uid: string}>} 처리 결과
 */
async function handleUserBirthYearMonthDayUpdate(uid, beforeValue, afterValue) {
 ...
 * @returns {Promise<{success: boolean; uid: string}>} 처리 결과
 */
async function handleUserGenderUpdate(uid, beforeValue, afterValue) {
