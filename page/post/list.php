                            ...
                            <article class="post-card" data-post-id="<?= $post->id ?>">
                                ...
                                <?php if (!empty($post->files)): ?>
                                    ...
                                    <div class="post-images">
                                        <?php foreach ($files as $file): ?>
                                            <img src="<?= htmlspecialchars(trim($file)) ?>" alt="Post image" class="post-image">
                                        <?php endforeach; ?>
                                    </div>
                                <?php endif; ?>
                                ...
                                <div class="post-footer">
                                    <div class="post-actions">
                                        ...
                                        <a href="<?= href()->post->view($post->id) ?>" class="action-btn">
        ...
        template: `
            <div>
                ...
                <article v-for="post in posts" :key="post.id" class="post-card">
                    ...
                    <!-- 게시글 이미지 -->
                    <div v-if="post.files && post.files.length > 0" class="post-images">
                        <img v-for="(file, index) in post.files" :key="index"
                             :src="file" alt="Post image" class="post-image">
                    </div>
