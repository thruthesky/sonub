...
<style>
    #login-app .btn.country-select-btn {
        transition: all 0.25s ease !important;
        cursor: pointer;
        border-radius: 12px !important;
    }

    #login-app .btn.country-select-btn:hover {
        background-color: #e8eaed !important;
        transform: translateY(-2px) scale(1.02) !important;
        box-shadow: 0 6px 20px rgba(0, 0, 0, 0.08) !important;
    }

    #login-app .btn.country-select-btn:active {
        transform: translateY(0) scale(0.98) !important;
        box-shadow: 0 2px 8px rgba(0, 0, 0, 0.06) !important;
    }
</style>

<div id="login-app" class="container py-5 mb-5">
            ...
            <form @submit.prevent id="login-form">
                ...
                <section v-show="step === 'select-country'">
                    <div class="text-center mb-5">
                        <p class="fs-6 fw-semibold text-secondary">1. <?= t()->어느_국가에서_로그인하시나요 ?></p>
                    </div>
                    ...
                    <div class="d-flex gap-3 justify-content-center mb-5">
                        ...
                        <button
                            ...
                            class="btn bg-light py-3 px-5 d-flex flex-column align-items-center country-select-btn"
                ...
                <section v-show="step === 'select-country-other'">
                    ...
                    <div class="list-group" style="max-height: 400px; overflow-y: auto;">
                        <button
                            ...
                            class="list-group-item list-group-item-action text-start py-3">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div class="d-flex align-items-center gap-2">
                                <span class="fs-2">{{ selectedCountryInfo.flag }}</span>
                                <div>
                                    <span class="fw-semibold">{{ selectedCountryInfo.name }}</span>
                                    <span class="text-muted ms-2">+{{ selectedCountryInfo.dial }}</span>
                                </div>
                            </div>
                            <button
                                type="button"
                        ...
                        <div class="mb-4">
                            <label for="phone_number" class="form-label">2. <?= t()->전화번호 ?></label>
                            <input
                                type="tel"
                                v-model="phoneNumber"
                                class="form-control py-2"
                ...
                <section v-show="step === 'input-sms-code'">
                    <div class="mb-5">
                        <div class="mb-4">
                            <label for="sms_code" class="form-label">3. <?= t()->SMS_코드 ?></label>
                            <input
                                type="text"
                                v-model="smsCode"
                                id="sms_code"
                        ...
                        <div class="text-center" v-if="showResetButton">
                            <button
                                type="button"
                                class="btn btn-link"
                                @click="resetForm">
